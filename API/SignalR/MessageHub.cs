...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            var otherUser = httContext.Request.Query["user"].ToString();
            ...
            //na Repositoriju ne shranimo, ker je za to odgovoren UinitOfWork
            if (_unitOfWork.HasChanges()) await _unitOfWork.Complete();

            await Clients.Caller.SendAsync("ReceviesMessageThread", messages);
        }
